...
- QUAN TRỌNG: Chỉ dùng dữ liệu TRA CỨU nếu nó mô tả ĐÚNG tình huống người dùng gặp phải. Nếu dữ liệu TRA CỨU kể chuyện khác (ví dụ: giả danh công an, yêu cầu CCCD, OTP), đừng copy tên hay chi tiết cụ thể từ đó vào câu trả lời.
